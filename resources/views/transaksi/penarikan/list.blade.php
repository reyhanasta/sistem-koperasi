    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <a href="{{url('tr-withdraw/create/')}}" class="btn btn-primary"><i class="fas fa-plus"></i><span> Tambah</span></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="{{ url('customer/'.$index->customer_acc->id_customer)}}">{{$index->customer_acc->id}}</a></td>
