                    ...
                    @if ($pinjaman->status == 'diajukan')
                        @if (auth()->user()->hasRole('admin'))
                            <form
                                ...
                                {{-- <a href="" class="btn btn-success">Setujui Pinjaman</a> --}}
                            </form>
                        @else
                    ...
                    <form action="{{ url('trx-angsuran') }}" method="POST">
                        ...
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><input type="text" name="jumlah_simpanan" id="modal-jumlah-bayar"
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><input type="number" name="angsuran" id="modal-jumlah-angsuran"
                                        value="{{ $pinjaman->angsuran }}" readonly class="form-control"></td>
                            </tr>
                            <tr>
                                <td>Angsuran ke </td>
                                <td>:</td>
                                <td><input type="number" name="jumlah_angsuran" required class="form-control"
                                        value="{{ $pinjaman->jumlah_angsuran + 1 }}" readonly></td>
                            </tr>
