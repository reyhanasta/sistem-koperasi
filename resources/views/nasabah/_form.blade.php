    ...
    <div class="form-group">
      ...
      <div class="input-group">
          <div class="custom-file">
              ...
              <label class="custom-file-label" for="ktp_image_path">{{ $data->ktp_image_path }}</label>
          </div>
      </div>
  </div>
  @if (strlen($data->ktp_image_path) > 0)
      <img class="profile-user-img img-fluid img-circle" src="{{ asset('picture/' . $data->ktp_image_path) }}"
